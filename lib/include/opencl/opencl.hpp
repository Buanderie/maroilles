...
namespace mrl
{
    namespace opencl
    {
        ...
        public:
            ...
            void enqueueKernel(Kernel* kernel , const size_t localWorkSize, const size_t globalWorkSize);
            /* TODO */
        ...
        public:
            ...
            void setLocalArgument( const size_t& localMemorySize ){ clSetKernelArg( _kernelId, _argCount++, localMemorySize, NULL); }
            void clearArguments();
